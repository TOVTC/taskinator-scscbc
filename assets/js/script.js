...
var createTaskEl = function(taskDataObj){
    ...
    tasksToDoEl.appendChild(listItemEl);
    //add an id property to the taskDataObj argument and then sync that package with the object array
...
var createTaskActions = function(taskId) {
    ...
    //add a for loop to assign values to the select options
...
//add an event listener for the page content to enable button functionality
pageContentEl.addEventListener("click", taskButtonHandler);

//add an event listener to check for when select dropdown changes values
